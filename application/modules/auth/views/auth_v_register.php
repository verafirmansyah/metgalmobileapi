...
<body class="hold-transition register-page animsition">
  ...
  <div class="register-box-body">
    ...
    <form action="#" method="post" id="regForm" data-toggle="validator">
      ...
      <div class="row form-group has-feedback">
        ...
        <!-- /.col -->
        <div class="col-xs-4">
          <button type="submit" id="btnSimpan" class="btn btn-primary btn-block btn-flat pull-right"  data-loading-text="<i class='fa fa-circle-o fa-spin'></i> Register">Register</button>
        </div>
        <!-- /.col -->
      </div>
    </form>
      ...
      $( "#regForm" ).validate( {
          ...
          rules: {
              ...
              user_email: {
                  ...
                  strictemail: true,
                  remote: {
                      url: "<?php echo site_url(); ?>auth/daftar_cek_email",
                      type: "post"
                  }
              },
              // hiddenRecaptcha: {
          ...
          submitHandler: function () {
              ...
              $.ajax({
                  url : '<?php echo site_url(); ?>auth/daftar_action',
                  type: "POST",
                  data: formData,
                  contentType: false,
                  processData: false,
